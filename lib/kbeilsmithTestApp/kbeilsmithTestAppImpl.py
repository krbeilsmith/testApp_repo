...
This sample module contains one small method that filters contigs.
    ...
    def run_kbeilsmithTestApp(self, ctx, params):
        """
        ...
        #BEGIN run_kbeilsmithTestApp

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_kbeilsmithTestApp function. Params=' + pformat(params))
        ...
        #END run_kbeilsmithTestApp

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_kbeilsmithTestApp return value ' +
